...
function getReactElementRef(element) {
  var _a;
  if (parseInt(React14.version, 10) >= 19) {
...
var useInsertionEffectWithLayoutFallback = useInsertionEffect2 || React15.useLayoutEffect;

// node_modules/@emotion/react/dist/emotion-element-489459f2.browser.development.esm.js
var EmotionCacheContext = React16.createContext(
...
var Emotion = withEmotionCache(function(props, cache, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, void 0, React16.useContext(ThemeContext));
  ...
  return React16.createElement(React16.Fragment, null, React16.createElement(Insertion, {
    cache,
    serialized,
    isStringTag: typeof WrappedComponent === "string"
  }), React16.createElement(WrappedComponent, newProps));
});
{
...
var Global = withEmotionCache(function(props, cache) {
  ...
  var serialized = serializeStyles([styles], void 0, React17.useContext(ThemeContext));
...
var ClassNames = withEmotionCache(function(props, cache) {
  ...
  hasRendered = true;
  return React17.createElement(React17.Fragment, null, React17.createElement(Insertion3, {
    cache,
    serializedArr
  }), ele);
});
...
true ? StyledEngineProvider.propTypes = {
   ...
   */
  enableCssLayer: import_prop_types4.default.bool,
  /**
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = React19.useContext(ThemeContext);
      }
      if (typeof props.className === "string") {
      ...
      return React19.createElement(React19.Fragment, null, React19.createElement(Insertion5, {
        cache,
        serialized,
        isStringTag: typeof FinalTag === "string"
      }), React19.createElement(FinalTag, newProps));
    });
...
function useTheme2(defaultTheme5 = null) {
  const contextTheme = React21.useContext(ThemeContext);
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React33.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React33.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React33.useMemo(() => storageManager == null ? void 0 : storageManager({
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React34.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => React34.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const ctx = React34.useContext(ColorSchemeContext);
    const nested = !!ctx && !disableNestedContext;
    const initialTheme = React34.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React34.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const element = (0, import_jsx_runtime11.jsxs)(React34.Fragment, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YNA7H5BF.js.map
